...
vueScript.setAttribute('src', 'https://unpkg.com/vue'), vueScript.onload = init, document.head.appendChild(vueScript), document.head.appendChild(styles); 
declare var Vue:any
function init() { 
    ...
    new Vue({
         data: { versions: 
            ...
            methods: { 
                open(b:any) { require('electron').shell.openExternal(b) 
            } 
            }, 
